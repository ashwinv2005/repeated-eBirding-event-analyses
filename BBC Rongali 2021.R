...
nms = read.delim("ebd_IN_202104_202104_relApr-2021.txt", nrows = 1, sep = "\t", header = T, quote = "", stringsAsFactors = F, 
                 na.strings = c(""," ",NA))
nms = names(nms)
...
data1 = read.delim("ebd_IN_202104_202104_relApr-2021.txt", colClasses = nms, sep = "\t", header = T, quote = "", 
...
data = data %>% filter(OBSERVATION.DATE %in% c("2021-04-14","2021-04-15","2021-04-16","2021-04-17"))
...
write.csv(temp,"BBCRongalispecieslist2021.csv", row.names=FALSE)
...
data$FIRST.NAME[data$obs.id.num == "2423520"] = "Lamin"
data$LAST.NAME[data$obs.id.num == "2423520"] = "lamin"
data$FIRST.NAME[data$obs.id.num == "2417477"] = "Maybornroy"
data$LAST.NAME[data$obs.id.num == "2417477"] = "Thma"
data$FIRST.NAME[data$obs.id.num == "2424224"] = "Comely"
data$LAST.NAME[data$obs.id.num == "2424224"] = "Gassah"
data$FIRST.NAME[data$obs.id.num == "2420691"] = "Dipika"
data$LAST.NAME[data$obs.id.num == "2420691"] = "Chetry"
data$FIRST.NAME[data$obs.id.num == "2434656"] = "Saptarshi"
data$LAST.NAME[data$obs.id.num == "2434656"] = "Chanda"
data$FIRST.NAME[data$obs.id.num == "1159614"] = "Subhash"
data$LAST.NAME[data$obs.id.num == "1159614"] = "Chanda"
data$FIRST.NAME[data$obs.id.num == "1298939"] = "Atanu"
data$LAST.NAME[data$obs.id.num == "1298939"] = "Mondal"
data$FIRST.NAME[data$obs.id.num == "2483199"] = "Birdinghimalayas"
data$LAST.NAME[data$obs.id.num == "2483199"] = "Team"
data$FIRST.NAME[data$obs.id.num == "2420992"] = "Sabia"
data$LAST.NAME[data$obs.id.num == "2420992"] = "Taqi"
data$FIRST.NAME[data$obs.id.num == "2415584"] = "Bishal"
data$LAST.NAME[data$obs.id.num == "2415584"] = "Basumatary"
data$FIRST.NAME[data$obs.id.num == "2421117"] = "Barshashri"
data$LAST.NAME[data$obs.id.num == "2421117"] = "Talukdar"
data$FIRST.NAME[data$obs.id.num == "2119830"] = "Manas"
data$LAST.NAME[data$obs.id.num == "2119830"] = "Haloi"
data$FIRST.NAME[data$obs.id.num == "2421170"] = "Nibedita"
data$LAST.NAME[data$obs.id.num == "2421170"] = "Kalita"
data$FIRST.NAME[data$obs.id.num == "1188361"] = "Suranjan"
data$LAST.NAME[data$obs.id.num == "1188361"] = "Debnath"
data$FIRST.NAME[data$obs.id.num == "2421191"] = "Sajit"
data$LAST.NAME[data$obs.id.num == "2421191"] = "Karki"
data$FIRST.NAME[data$obs.id.num == "2421168"] = "Neha"
data$LAST.NAME[data$obs.id.num == "2421168"] = "Kumari"
data$FIRST.NAME[data$obs.id.num == "2428062"] = "DEBASMITA"
data$LAST.NAME[data$obs.id.num == "2428062"] = "PURKAYASTHA"
data$FIRST.NAME[data$obs.id.num == "2433034"] = "Riezuwan"
data$LAST.NAME[data$obs.id.num == "2433034"] = "Mondal"
data$FIRST.NAME[data$obs.id.num == "2444092"] = "Nipanjyoti"
data$LAST.NAME[data$obs.id.num == "2444092"] = "Nath"
data$FIRST.NAME[data$obs.id.num == "2433018"] = "Jahangir"
data$LAST.NAME[data$obs.id.num == "2433018"] = "Alom"
...
datax = data %>%
  ...
  arrange(DISTRICT)
write.csv(datax,"BBCRongalibirdersperdistrict2021.csv", row.names=FALSE)
...
datax = data %>%
  ...
  arrange(desc(lists))
write.csv(datax,"BBCRongalilistsperdistrict2021.csv", row.names=FALSE)
...
datax = data %>%
  ...
  arrange(desc(lists))
write.csv(datax,"BBCRongalilistsperday2021.csv", row.names=FALSE)
...
write.csv(datax,"BBCRongalilistsperdaydistrict2021.csv", row.names=FALSE)
...
mapshot(a, "BBCRongali_districts_2021.html")
...
write.csv(regionsummary,"BBCRongali_REGIONsummary2021.csv",row.names = F)
...
write.csv(cosp,"BBCRongali_CommonSpeciesbyRegion2021.csv",row.names = F)
...
extra$region = c("North Assam Division","Lower Assam Division","Central Assam Division","Central Assam Division",
...
n1 = "BBCRongaliregionmap2021.jpg"
